 ...
 */
public class SingleInstanceSecondActivity extends BaseActivity implements View.OnClickListener {


    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_single_instance_second);
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.btn_go_first:
                startActivity(new Intent(this, SingleInstanceFirstActivity.class));
                break;
        }
    }
}
