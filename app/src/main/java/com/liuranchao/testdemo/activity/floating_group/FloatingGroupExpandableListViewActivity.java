...
/**
 * Description: 测试收起展开 悬浮header的ListView
 *
 * @author liuranchao
...
public class FloatingGroupExpandableListViewActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_floating_group_expandable_listview);
        ...
        final FloatingGroupExpandableListViewAdapter adapter = new FloatingGroupExpandableListViewAdapter(this);
